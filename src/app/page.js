          ...
          >
            <div
              style={{
                ...
                boxShadow:
                  '0 0 0 4px rgba(124,58,237,0.1), 0 0 30px rgba(124,58,237,0.2)',
                overflow: 'hidden',
  ...
  return (
    ...
    >
      <motion.div {...fadeUp()}>
        ...
        >
          Three projects built with care. Each starts with a real problem and
          ends with a shipped product.
        </p>
      </motion.div>
          ...
          <motion.div key={project.id} {...fadeUp(i * 0.1)}>
            ...
            >
              ...
              <div
                style={{
                  height: 180,
                  background: `linear-gradient(135deg, ${project.colorDim}, rgba(9,9,11,0.8))`,
                  position: 'relative',
                  overflow: 'hidden',
                  display: 'flex',
                  alignItems: 'center',
              ...
              >
                <div
                  style={{
                    width: '100%',
                    height: '100%',
                    backgroundImage: `url(${project.image?.src || project.image})`,
                ...
                <div
                  style={{
                    position: 'absolute',
                    inset: 0,
                    background: `linear-gradient(to bottom, transparent, ${project.colorDim})`,
                  }}
                />
                ...
                <div
                  style={{ position: 'absolute', fontSize: 40, opacity: 0.15 }}
                >
                  {i === 0 ? '📚' : i === 1 ? '🎨' : '💼'}
                </div>
              </div>
...
function BlogPreview() {
  return (
    <section style={{ padding: '6rem 2rem', maxWidth: 1100, margin: '0 auto' }}>
      ...
      >
        <div>
          <SLabel>// Writing</SLabel>
          <STitle>From the blog.</STitle>
        </div>
        <Link
          href="/blog"
          style={{
