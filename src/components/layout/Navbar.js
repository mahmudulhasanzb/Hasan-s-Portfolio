    ...
    <>
      <header
        style={{
          ...
          transition:
            'transform 0.3s cubic-bezier(0.4,0,0.2,1), background 0.3s, border-color 0.3s',
            ...
            {links.map(({ href, label }) => (
              <Link
                ...
                style={{
                  ...
                  background:
                    pathname === href ? 'rgba(124,58,237,0.2)' : 'transparent',
                  transition: 'all 0.2s',
                }}
                onMouseEnter={(e) => {
                  if (pathname !== href) e.currentTarget.style.color = '#fff';
                }}
                onMouseLeave={(e) => {
                  if (pathname !== href)
            ...
            {links.map(({ href, label }) => (
              <Link
                ...
                style={{
                  ...
                  color:
                    pathname === href ? 'var(--purple-light)' : 'var(--text-2)',
                }}
              >
                {label}
              </Link>
