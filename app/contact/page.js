        ...
        >
          ...
          >
            ...
            <p style={{ fontSize: 13, color: 'var(--text-2)' }}>
              ...
              . For any urgent matters, call me on
              <Link
                href={'https://wa.me/+8801756324260'}
                className="font-bold text-[rgba(124,58,237,0.9)] underline-offset-4 underline hover:text-white transition-colors duration-500 flex items-center gap-2"
                target="_blank"
                rel="noopener noreferrer"
              >
